 ...
 * {@link Labeled} annotation. A {@link Labeled} annotation acts as a name of shard to be
 * injected. The resultant {@link Shard} is {@link Askable}.
 *
...
public class ShardFactory {
	...
	/**
	 * Create labeled {@link Shard} instance with {@link Dependent} scope. This method is
	 * meant to be invoked by the CDI SPI.
	 *
